    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-primary transition-colors inline-flex items-center gap-2"
              >
                @{process.env.NEXT_PUBLIC_INSTAGRAM_USERNAME || 'evozzn'}
              </a>
            </div>
            <div>
              <h3 className="text-primary font-semibold mb-2 flex items-center gap-2">
      ...
      <section className="bg-gradient-to-r from-primary/10 to-secondary/10 p-12 rounded-lg text-center border border-primary/20">
        ...
        <p className="text-gray-400 mb-6">
          Clique no botão abaixo e fale diretamente conosco. Atendimento rápido
          e personalizado.
        </p>
        <a
          href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '5571987497742'}?text=Olá,%20gostaria%20de%20saber%20mais%20sobre%20os%20serviços%20da%20Evozzn`}
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold px-8 py-4 rounded-lg transition-colors duration-200"
        >
          <svg
            className="w-5 h-5"
            fill="currentColor"
